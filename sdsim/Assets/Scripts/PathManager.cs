...
public class PathManager : MonoBehaviour {
	...
	public bool doLoadScriptPath = true;
    ...
    public string pathToLoad = "/Users/edwardkim/Desktop/sandbox3/sdsim/Assets/Resources/racePi2.txt";
	...
	{
		Debug.Log("InitNewRoad() called... "+ Directory.GetCurrentDirectory());
		if(doMakeRandomPath)
		{
			Debug.Log("MakeRandomPath() called");
			MakeRandomPath();
		}
		else if (doLoadScriptPath)
		{
			Debug.Log("loadscriptPath called");
			MakeScriptedPath();
		}
	...
	{
		Debug.Log("MakeScriptedPath() starting...");
